...
| 4 — UI kit playground | [`qcobjects-ui-kit`](../qcobjects-ui-kit) | Reusable widget kit (card, counter, tabset, composed panel with nested components) + live shadow-DOM inspector. Files upstream blocker `QuickCorp/QCObjects#120`. | ✅ |
